...
Dieses Kapitel beschreibt den technischen Aufbau von WissensWerk. Die einzelnen Dokumente erläutern die Architektur, Struktur und Organisation des Projekts.
...
- [🏗️ AR-011 UI-Komponentenarchitektur](./ar-011-ui-komponenten.md)
